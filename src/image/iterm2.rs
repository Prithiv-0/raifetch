...
impl ImageBackend for ITerm2Backend {
    ...
    fn is_supported(&self) -> bool {
        if let Ok(prog) = env::var("TERM_PROGRAM") {
            if prog == "iTerm.app" || prog == "WezTerm" || prog == "vscode" || prog == "mintty" || prog == "Apple_Terminal" {
                return true;
            }
        }
        false
    ...
    fn render(&self, img: &DynamicImage, cols: u16, rows_hint: u16) -> anyhow::Result<(String, u16, u16)> {
